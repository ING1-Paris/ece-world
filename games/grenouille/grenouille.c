...
#define RIVIERE_END_SAVE_FILE "games/grenouille/end.txt"
#define RIVIERE_BEST_SAVE_FILE "games/grenouille/best.txt"
...
int main() {
    ...
    BITMAP *frog_bmp = load_bitmap("games/grenouille/assets/grenouilleoff.bmp", NULL);
    BITMAP *log_bmp = load_bitmap("games/grenouille/assets/bois.bmp", NULL);
    BITMAP *fond = load_bitmap("games/grenouille/assets/fondfrog.bmp", NULL);
